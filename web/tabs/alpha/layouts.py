...
def build_candidates_layout() -> html.Div:
    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                html.H6("Seasonal Screener", style={'color': THEME['text_main'], 'margin': '0'}),
                html.Span(
                    "Cross-instrument consistency table for the selected month. "
                    "Reads seasonal-spds.pkl (generated by EOD StatGenerator).",
            ...
            html.Div([
                html.Div([
                    html.Label("Spread Type", style={'color': THEME['text_sub'], 'fontSize': '11px', 'marginBottom': '3px', 'display': 'block'}),
                    dcc.Dropdown(
                        id='seasonal-screener-stype',
                        options=[
                            {'label': 'Tenor Spreads',           'value': 'TenorSpread'},
                            {'label': 'Bond-Swap (Treasury)',     'value': 'TBondSwap'},
                            {'label': 'Bond-Swap (Policybank)',   'value': 'CBondSwap'},
                            ...
                            {'label': 'Futures vs Swap',          'value': 'FuturesSwap'},
                        ],
                        value='TenorSpread',
                        clearable=False,
                ...
                html.Div([
                    html.Label("Month", style={'color': THEME['text_sub'], 'fontSize': '11px', 'marginBottom': '3px', 'display': 'block'}),
                    dcc.Dropdown(
                        id='seasonal-screener-month',
                        options=[
                            {'label': m, 'value': i + 1}
                ...
                html.Div([
                    html.Label("Min Years", style={'color': THEME['text_sub'], 'fontSize': '11px', 'marginBottom': '3px', 'display': 'block'}),
                    dcc.Dropdown(
                        id='seasonal-screener-min-years',
                        options=[
                            {'label': '3', 'value': 3},
                            {'label': '4', 'value': 4},
                            {'label': '5', 'value': 5},
                ...
                html.Div([
                    html.Label("p < threshold", style={'color': THEME['text_sub'], 'fontSize': '11px', 'marginBottom': '3px', 'display': 'block'}),
                    dcc.Dropdown(
                        id='seasonal-screener-p-thresh',
                        options=[
                            {'label': '0.05', 'value': 0.05},
                            {'label': '0.10', 'value': 0.10},
                            {'label': '0.20', 'value': 0.20},
                            {'label': 'Any',  'value': 1.00},
                        ],
