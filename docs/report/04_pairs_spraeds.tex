\section{Relative Value: Pairs \& Spreads (\texttt{pairs/})}

\subsection{Regression (\texttt{pairs/stats.py})}
...
\subsection{Spread Families (Alpha Book $\rightarrow$ Spread)}
...
\subsection{Alpha Portfolio $\rightarrow$ Backtest: Style-routed Spread Strategies}
...
\begin{tabular}{p{0.16\textwidth} p{0.24\textwidth} p{0.28\textwidth} p{0.24\textwidth}}
\hline
...
\hline
\end{tabular}
\caption{Style-routed spread strategy types.}
\label{tab:pairs-strategy-types}
\end{table}

\subsubsection{Regime Selection and Scope}
...
\subsubsection{Mean-reversion Model and Defaults}
...
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{p{0.30\textwidth} p{0.16\textwidth} p{0.18\textwidth} p{0.28\textwidth}}
\hline
...
\hline
\end{tabular}
\caption{Mean-reversion strategy defaults.}
\label{tab:pairs-mr-defaults}
\end{table}
...
\subsubsection{Trending / Momentum Model and Defaults}
...
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{p{0.24\textwidth} p{0.17\textwidth} p{0.19\textwidth} p{0.32\textwidth}}
\hline
\textbf{Parameter} & \textbf{Standard default} & \textbf{Tenor-spread preset} & \textbf{Role} \\
\hline
...
\hline
\end{tabular}
\caption{Trending/momentum strategy defaults.}
\label{tab:pairs-trend-defaults}
\end{table}
...
\subsubsection{Portfolio Aggregation and Measurement Limitations}
...
\subsubsection{Performance-improvement Plan (Documentation Only)}
